...
if [ "$CI_PULL_REQUEST" = "" ]; then
  ...
  openssl aes-256-cbc -d -in "$DIR_OF_SCRIPT/data-integration-test-3ef5881802cc.json.enc" -out "$DIR_OF_SCRIPT/data-integration-test-3ef5881802cc.json" -k $ENCRYPTKEY
